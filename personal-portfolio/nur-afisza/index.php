...
<?php include "../back-button.html" ?>
  <div class="text-center">
    ...
    <img src="images.jpg" style="width:100%; height: 300px;" alt="...">
  </div>
  ...
  <div id="carouselExampleControls" class="carousel slide text-center carousel-dark" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="rounded-circle shadow-1-strong mb-xl-5" src="giphy.gif" sstyle="width: 200px;" />
    ...
    <div class="container my-2">
      ...
      <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        <div class="card-body">
          ...
          <p>
            <li> DALAM KOMPUTER, HARDWARE KOMPUTER, PERISIAN-PERISAIAN, FORMAT KOMPUTER DAN PRINTER</li>
          </p>
